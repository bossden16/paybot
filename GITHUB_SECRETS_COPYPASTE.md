...
- If you use GitHub repository Variables (`Settings → Secrets and variables → Actions → Variables`), set `RAILWAY_SERVICE` or other gating variables there as needed.
