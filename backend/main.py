...
async def lifespan(app: FastAPI):
    ...
    if not settings.jwt_secret_key:
        logger.warning(
            "JWT_SECRET_KEY is not configured. A temporary secret was generated for this session — "
            "all sessions will be invalidated on restart. Set JWT_SECRET_KEY in your .env or environment variables for production use."
        )
